...
use crate::{CollectError, Collector, Health, every_seconds_of_collector};
...
const WHEN_THE_VOCABULARY_IS_SILENT: u32 = 60;
...
impl FirewallCollector {
    ...
    fn stale_after_seconds(&self) -> u64 {
        u64::from(every_seconds_of_collector(NAME).unwrap_or(WHEN_THE_VOCABULARY_IS_SILENT))
            * STALE_AFTER_PERIODS
    }
