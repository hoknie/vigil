...
fn reading() {
    println!("processes: this reading is taken on Linux and on macOS; nothing to measure here");
}
...
fn searching() {
    let read = vigil_processes::fixture::processes();
