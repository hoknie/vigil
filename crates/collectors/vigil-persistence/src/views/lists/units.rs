...
pub(crate) fn cells(key: &str, item: &Value, depth: u8, parents: usize, wide: bool) -> Vec<String> {
    let mut cells = vec![
...
pub(crate) fn named(key: &str, item: &Value, depth: u8, parents: usize) -> String {
...
pub(crate) fn first_command(item: &Value) -> String {
