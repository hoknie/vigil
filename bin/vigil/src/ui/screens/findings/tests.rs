...
#[test]
fn an_agent_with_nothing_to_report_says_that_nothing_is_being_held_back() {
    let mut view = fixture::view();
    view.found.findings.clear();
...
#[test]
fn what_was_dropped_past_the_cap_is_on_the_screen() {
    let mut view = fixture::view();
    view.found.dropped = 12;

    assert!(drawn(&view, &Filter::default(), 80).contains("12 dropped"));
}
