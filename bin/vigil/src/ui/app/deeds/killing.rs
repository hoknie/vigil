...
const NOTHING_TO_ACT_ON: &str = "Nothing on this list is closed or stopped. The sockets and the \
                                 ...
                                 and D, and what starts by itself is stopped with U.";
...
impl App {
    pub(in crate::ui::app) fn kill_target(&self) -> Option<KillTarget> {
    ...
    pub(in crate::ui::app) fn killing(&mut self) {
    ...
    pub(in crate::ui::app) fn what_a_kill_would_take(&self) -> Vec<String> {
    ...
    pub(in crate::ui::app) fn chose_a_way_of_killing(&mut self, target: KillTarget, at: usize) {
